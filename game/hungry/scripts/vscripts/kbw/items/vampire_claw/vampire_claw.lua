...
LinkLuaModifier("modifier_item_vampire_claw", 'kbw/items/vampire_claw/modifier_item_vampire_claw', LUA_MODIFIER_MOTION_NONE)

--------------------------------------------------------------------------------
function item_vampire_claw:GetIntrinsicModifierName()
    return "m_mult"
end
function item_vampire_claw:GetMultModifiers()
    return {
		m_item_generic_attack = 0,
		m_item_generic_lifesteal = 0,
		modifier_item_vampire_claw = 0,
	}
end
--------------------------------------------------------------------------------
