...
function Spawn(entityKeyValues)
	...
	ABILITY_12_wave_bloodlust = thisEntity:FindAbilityByName("12_wave_bloodlust_extreme")
	ABILITY_12_wave_roots = thisEntity:FindAbilityByName("12_wave_roots_extreme")
