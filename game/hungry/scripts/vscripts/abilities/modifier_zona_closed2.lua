modifier_zona_closed_debuff2 = class({})

------------------------------------------------------------------------------------

function modifier_zona_closed_debuff2:IsPurgable()
	return false
end
function modifier_zona_closed_debuff2:IsDebuff() return true end
------------------------------------------------------------------------------------

function modifier_zona_closed_debuff2:OnCreated( kv )
...
function modifier_zona_closed_debuff2:GetTexture()
	return "custom/vampire_life_drain"
end

function modifier_zona_closed_debuff2:IsPurgeException()
	return false
end
--------------------------------------------------------------------------------

function modifier_zona_closed_debuff2:OnIntervalThink()
	if IsServer() then
