modifier_zona_closed_debuff4 = class({})

------------------------------------------------------------------------------------

function modifier_zona_closed_debuff4:IsPurgable()
	return false
end
function modifier_zona_closed_debuff4:IsDebuff() return true end
------------------------------------------------------------------------------------

function modifier_zona_closed_debuff4:OnCreated( kv )
...
function modifier_zona_closed_debuff4:GetTexture()
	return "custom/vampire_life_drain"
end

function modifier_zona_closed_debuff4:IsPurgeException()
	return false
end
--------------------------------------------------------------------------------

function modifier_zona_closed_debuff4:OnIntervalThink()
	if IsServer() then
