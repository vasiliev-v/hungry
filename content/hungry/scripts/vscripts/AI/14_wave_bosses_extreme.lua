...
function Spawn(entityKeyValues)
	...
	ABILITY_14_wave_storm_bolt = thisEntity:FindAbilityByName("14_wave_storm_bolt_extreme")
...
function Think14Wave()
	...
	if ABILITY_14_wave_storm_bolt:IsFullyCastable() and not thisEntity:IsStunned()  then
