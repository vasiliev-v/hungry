...
function Spawn(entityKeyValues)
	...
	ABILITY_14_wave_shadow_strike = thisEntity:FindAbilityByName("14_wave_shadow_strike_extreme")
...
function AIThink()
	...
	if ABILITY_14_wave_shadow_strike:IsFullyCastable() and not thisEntity:IsStunned()  then
