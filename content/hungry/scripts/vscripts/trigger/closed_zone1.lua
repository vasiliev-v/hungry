LinkLuaModifier( "modifier_zona_closed_debuff1", "abilities/modifier_zona_closed1", LUA_MODIFIER_MOTION_NONE )
local time = nil
...
function ZonaIn(trigger)
    ...
    hero:AddNewModifier(hero, hero, "modifier_zona_closed_debuff1", {})
...
function ZonaOut(trigger)
    local hero = trigger.activator
    if hero:HasModifier("modifier_zona_closed_debuff1") then
        hero:RemoveModifierByName("modifier_zona_closed_debuff1")
        time = nil
    end
