...
function modifier_item_void_stick:OnCreated()
	...
	self.spell_amp 				= ability:GetSpecialValueFor("spell_amp") or 0
...
function modifier_item_void_stick:GetModifierSpellAmplify_Percentage( params ) return self.spell_amp end
